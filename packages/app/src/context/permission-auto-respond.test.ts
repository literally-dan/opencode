...
describe("autoRespondsPermission", () => {
  ...
  test("does not inherit auto-accept when the Task owner differs from the parent", () => {
    const directory = "/tmp/project"
  ...
  test("does not inherit auto-accept across a Task project boundary", () => {
    const directory = "/tmp/project"
  ...
  test("inherits auto-accept after the root moves to another location", () => {
    const directory = "/tmp/project"
    const sessions = [
      session({ id: "root", workspaceID: "moved", directory: "/tmp/moved", path: "moved" }),
